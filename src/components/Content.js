      ...
      <div className="flex column section">
        ...
        <Collapse style={{textAlign: 'left'}} ghost>
          ...
          <Collapse.Panel header="Can a UTI go away on its own?" key="4">
            <p>It is best to see a provider if you are experiencing symptoms of a urinary tract infection (UTI). Leaving it untreated may result in a more serious infection that spreads to your kidneys. UTIRX.com offers online visits for UTI so that you can get started on treatment sooner.</p>
          </Collapse.Panel>
