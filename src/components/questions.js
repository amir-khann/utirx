const questions = [
  ...
  {
    question: "What causes a UTI?",
    answer:
      "Urinary tract infections (UTIs) happen when bacteria is able to get into the urinary tract, causing an infection. Different factors can increase the likelihood of this happening, like sexual activity, changes in hormone levels during menopause, pregnancy.",
  },
  {
    question: "Can a UTI go away on its own?",
    answer:
      "It is best to see a provider if you are experiencing symptoms of a urinary tract infection (UTI). Leaving it untreated may result in a more serious infection that spreads to your kidneys. UTIRX.com offers online visits for UTI so that you can get started on treatment sooner.",
  },
  {
  ...
  {
    question: "What is the best thing to do for a UTI?",
    answer:
  ...
  {
    question: "What is the main cause of UTIs in females?",
    answer:
  ...
  {
    question: "What does a UTI feel like?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Now you do not need to visit a provider’s office to be prescribed antibiotics for a simple urinary tract infection (UTI). Instead, you can be put in contact with a provider online from the comfort of your home, which can help you start treatment sooner.UTIRX.com offers online visits for UTI prescriptions for as low as $30.",
  },
  {
    question: "Will a UTI go away without antibiotics?",
    answer:
  ...
  {
    question: "How Can UTIRX.com Help with UTIs?",
    answer:
      "Most UTIs respond quickly to treatment with an appropriate antibiotic. UTIRX.com connect you with providers who can prescribe antibiotics. The exact treatment they prescribe depends on your diagnosis and history.Common Antibiotics Include:Macrobid (Nitrofurantoin)Keflex (Cephalexin)Bactrim (Sulfamethoxazole / Trimethoprim)",
  },
  {
    question: "Is This Service Right For Me?",
    answer:
      "Whether it’s your first UTI or you’ve had several (if so, we’re so sorry!), providers may be able to help.We’ll ask you a series of questions to see if this service is right for you. You will only proceed if we feel that this service will benefit you. If you are a good candidate.",
  },
];
